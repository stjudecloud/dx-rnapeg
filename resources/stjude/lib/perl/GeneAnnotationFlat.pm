package GeneAnnotationFlat;
# find HUGO gene annotations by location
# - this is a stripped-down version of GeneAnnotation avoiding DBI.pm
#   (problems with Docker images of rnapeg on DNAnexus)
#
# TO DO:
...
@GeneAnnotationFlat::ISA = qw(Configurable Exporter);
@GeneAnnotationFlat::EXPORT_OK = qw();
...
sub setup {
  ...
  if ($style eq "refgene") {
    die "not supported in GeneAnnotationFlat.pm";
